...
class ExercisePage(QFrame):
    def __init__(self, app):
        ...
        # ADD YOUR EXERCISE UI CODE HERE
        layout.addStretch()
...
# ==========================================
# PAGE 4: BATHROOM (Disconnected, 3x2 Grid with larger row gap)
# ==========================================
class BathroomPage(QFrame):
    def __init__(self, app):
        ...
        # --- THE FIX IS HERE ---
        # Set left-to-right gap
        grid.setHorizontalSpacing(25) 
        # Set top-to-bottom gap (Increase this number if you want even more space between rows!)
        grid.setVerticalSpacing(60)   
        
        grid.setContentsMargins(40, 10, 40, 10)
        
        # 6 independent options: 3 in the top row, 3 in the bottom row
        options = [
            # Top Row (Row 0)
            ...
            ("TEETH", "I need to brush my teeth.", "#F5B7B1", "teeth_pic.png", 1, 1),       
        ...
        back_btn.setStyleSheet("background-color: #BDBDBD; color: white; border-radius: 15px; font-weight: bold; font-size: 20px; border: none;")
        back_btn.clicked.connect(lambda: self.app.stack.setCurrentIndex(0))
        layout.addWidget(back_btn, alignment=Qt.AlignmentFlag.AlignCenter)
        layout.addSpacing(20)

    def handle_bathroom_selection(self, choice):
        # 1. Play the alert sound and show a clean popup confirming the choice
        self.app.trigger_alert(f"Assistance Requested: {choice}")
        
        # 2. Automatically return to the main menu after the user clicks 'OK' on the popup
        self.app.stack.setCurrentIndex(0)

# ==========================================
# PAGE 5: YES / NO (Response Page)
# ==========================================
class YesNoPage(QFrame):
    ...
    def show_result(self, choice):
        ...
        self.app.stack.setCurrentIndex(5) # Ensure we are on this page
...
# ==========================================
# PAGE 6: ENTERTAINMENT (Placeholder)
# ==========================================
class EntertainmentPage(QFrame):
    def __init__(self, app):
        ...
        # ADD YOUR ENTERTAINMENT UI CODE HERE
        layout.addStretch()
...
# ==========================================
# PAGE 7: RECOMMEND ANSWER (Placeholder)
# ==========================================
class RecommendPage(QFrame):
    def __init__(self, app):
        ...
        # ADD YOUR RECOMMEND UI CODE HERE
        layout.addStretch()
...
# ==========================================
# MAIN APP (Holds the Stacked Widget & Logic)
# ==========================================
class WellBeingApp(QWidget):
    def __init__(self):
        ...
        # Instantiate All 9 Pages and pass self (WellBeingApp) as the reference
        ...
        self.stack.addWidget(self.food_page)          # Index 1
        self.stack.addWidget(self.feeling_page)       # Index 2
        self.stack.addWidget(self.exercise_page)      # Index 3
        self.stack.addWidget(self.bathroom_page)      # Index 4
        self.stack.addWidget(self.yes_no_page)        # Index 5
        self.stack.addWidget(self.entertainment_page) # Index 6
        self.stack.addWidget(self.recommend_page)     # Index 7
        self.stack.addWidget(self.clock_page)         # Index 8
